...
namespace NpcProtector
{
    public class Program
    {
	    ...
	    "CaptainLonelyGale",
            ...
            "CorpulusVinius",
            "Cosnach",
	    "CRFFrostRiverDeminia",
	    "CRFFrostRiverMeaderyIddli",
	    "CRFFrostRiverMeaderySignar",
	    "CRFHeljarchenApothecaryFathenda",
	    "CRFHeljarchenBlacksmithTraillus",
	    "CRFHeljarchenFarmerJen",
	    "CRFHeljarchenHeigen",
	    "CRFKynesgroveFroa",
	    "CRFStonehillsBlacksmithAleuc",
            "Curwe",
            "CWBattleGalmar",
            "CWBattleTullius",
            "CWBattleUlfric",
